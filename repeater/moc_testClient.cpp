...
QT_MOC_LITERAL(5, 43, 9)
    ...
    "TestClient\0outMessage\0\0newFrame\0"
    "mocapStart\0mocapStop\0"
};
...
void TestClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->outMessage((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->newFrame((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->mocapStart(); break;
        case 3: _t->mocapStop(); break;
        default: ;
        }
        ...
        {
            typedef void (TestClient::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TestClient::outMessage)) {
                *result = 0;
            }
        }
        {
            typedef void (TestClient::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TestClient::newFrame)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void TestClient::outMessage(QString _t1)
{
...
// SIGNAL 1
void TestClient::newFrame(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };

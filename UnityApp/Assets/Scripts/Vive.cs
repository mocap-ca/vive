...
namespace Vive
{
	// A Speck is the baseclass for all items of which joints, markers or other primitives 
	// are subclassed from.  The name was chosen to be unique.  It represents the smallest
	...
	public abstract class Speck
	{
		...
		public Speck(string _name) { name = _name; }
